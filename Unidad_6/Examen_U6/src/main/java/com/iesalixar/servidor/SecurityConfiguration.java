...
import com.iesalixar.servidor.service.JPAUserDetailsService;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/profesores/asignaturas","/profesores").authenticated()
		.antMatchers("/profesores/addProfesor","/profesores/addAsignatura","/profesores/asignaturas").hasRole("ADMIN")
