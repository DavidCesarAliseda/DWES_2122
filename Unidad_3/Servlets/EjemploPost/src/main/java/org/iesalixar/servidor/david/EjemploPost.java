...
public class EjemploPost extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<label for=\"nombre\">Nombre:</label><input id=\"nombre\" type=\"text\" name=\"nombre\" required><br>");
		out.println(
				"<label for=\"apellidos\">Apellidos:</label><input id=\"apellidos\" type=\"text\" name=\"apellidos\" required ><br>");
